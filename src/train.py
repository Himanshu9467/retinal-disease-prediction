...
def train_model(model_name):
    ...
    for epoch in range(CONFIG["epochs"]):
        ...
        if epoch == 3:
            ...
            # =============================================
            # REBUILD OPTIMIZER AFTER UNFREEZE
            # =============================================
            ...
            if model_name in ["resnet", "efficientnet"]:
                ...
                for name, param in model.named_parameters():
                    ...
                    if (
                        (model_name == "resnet" and "fc" in name)
                        or
                        (model_name == "efficientnet" and "classifier" in name)
                    ):
                ...
                # =========================================
                # REBUILD SCHEDULER AFTER NEW OPTIMIZER
                # =========================================
